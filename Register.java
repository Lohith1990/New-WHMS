...
public class Register {
	...
	public String doLogin(@QueryParam("user_name") String name,
						  @QueryParam("user_mail") String uname,
		...
		if (retCode == 0) {
			...
			response = Utitlity
					.constructJSON("register", false, "Special Characters are not allowed in Username and Password");
		} else if (retCode == 3) {
